...
import { ArrayOf, Union, Schema, Decoded, Encoded, RecordOf, isOptional, schema, isStructuredSchema, isRest, TemplateLiteral } from './schema'
...
const encodeTemplateLiteral = <S>(s: TemplateLiteral<S>, x: unknown) => {
